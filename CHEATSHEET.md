...
> CC Commander v7.1.0 — by Kevin Zicherman — commands, workflows, and power user tips
...
## Desktop Plugin Commands (v7.1.0)
...
CC Commander v7.1.0 — the Desktop plugin is the primary surface. Invoke the interactive hub with plain `/ccc` in Claude Desktop:
...
## CC Commander v7.1.0 Quick Reference (CLI)
