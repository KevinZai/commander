...
description: "Ops relay for small businesses. Pushes CC Commander build, deploy, CI, task, and cost/budget signals to your team's everyday channels (chat / email) so non-devs know what shipped — without watching a terminal. Read-only relay; no secrets in payloads."
allowed-tools:
  - Read
  - Bash
  - AskUserQuestion
