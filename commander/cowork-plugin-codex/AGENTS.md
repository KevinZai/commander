...
The Codex-format mirror of the CC Commander plugin: 74 skills (`skills/*/SKILL.md`, byte-identical to the Claude Code tree), 22 specialist agent personas (`agents/*.toml`), the Codex-supported hook subset (`hooks.json`), and 2 credential-free MCP servers (`.mcp.json`).
