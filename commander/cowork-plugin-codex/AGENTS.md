...
> Generated by `npm run build:codex` from `commander/contract.json` v7.2.0. Do not edit by hand.

## What this directory is

The Codex-format mirror of the CC Commander plugin: 80 skills (`skills/*/SKILL.md`, byte-identical to the Claude Code tree), 22 specialist agent personas (`agents/*.toml`), the Codex-supported hook subset (`hooks.json`), and 2 credential-free MCP servers (`.mcp.json`).
