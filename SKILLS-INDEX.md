...
> CC Commander v6.0.0 — by Kevin Zicherman
...
*⭐ = added in CC Commander v6.0.0 and kept current with each release. Desktop plugin skills (plain `/ccc-*` namespace) added in v6.0.0, updated in v6.0.0.*
