...
*⭐ = added in CC Commander v6.6.0 and kept current with each release. Desktop plugin skills (plain `/ccc-*` namespace) added in v6.6.0, updated in v6.6.0.*
