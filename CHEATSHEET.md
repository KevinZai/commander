...
> CC Commander v6.5.0 — by Kevin Zicherman — commands, workflows, and power user tips
...
### /ccc-* Skills (71 plugin skills — 13 specialist workflows + 11 CCC domains + 6 channel/CI/ECC skills + Orchestrator/Executor + meta + vendor-sourced + lifecycle + session; core surface shown)
...
CC Commander v6.5.0 — the Desktop plugin is the primary surface. Invoke the interactive hub with plain `/ccc` in Claude Desktop:
...
## CC Commander v6.5.0 Quick Reference (CLI)
