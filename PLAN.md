...
| v4.0.0-beta.11 | 2026-04-23 | Hardening + Desktop-first positioning: 5 security fixes, XML strip (17 agents/skills), /ccc-e2e + /ccc-save-session + /ccc-resume-session skills (30→33), OG image, screenshot scaffold, comprehensive doc sync | 🔄 Current |
...
- **33 plugin skills** (13 /ccc-* specialist workflows + 14 ccc-* domain routers + 2 diagnostic/meta + 2 vendor-sourced + /ccc-save-session + /ccc-resume-session + /ccc-e2e — all free for now)
