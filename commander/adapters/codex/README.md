...
This adapter contains the translator, runtime hook detector, local telemetry hook, and the Codex-flavored manifest template. The build pipeline should import these ESM modules and write only generated output under `commander/cowork-plugin-codex/`.
