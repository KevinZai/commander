...
### Dynamic Filtering (Opus 5 / Sonnet 4.6)
...
**Supported models:** Claude Opus 5, Claude Sonnet 4.6, and Claude Haiku 4.5. Legacy models (Claude Opus 4.8, Claude Opus 4.5, Claude Opus 4.1) also support structured outputs.
