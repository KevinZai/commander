...
name: ccc-smb-ops
context: fork
description: "complete small-business-operations ecosystem — 6 skills in one. 13-week cash-flow forecasting, invoicing + AR chasing, payroll planning, CRM hygiene, expense tracking, and a weekly owner brief. Written for non-technical owners…"
allowed-tools:
  - Read
---
