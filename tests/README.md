...
- **Hook file existence** — All 14 wired kit-native hooks present
- **Hook syntax** — All JS hooks parse without errors
- **Proactive hooks** — context-guard, auto-checkpoint, cost-alert, confidence-gate, pre-compact, self-verify, etc.
