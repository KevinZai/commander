---
name: ccc-onboard
description: "[C:plugin] — CC Commander contributor onboarding workflow. Detects project conventions, asks for contributor role, builds a tailored first-hour checklist, starter links, and…"
model: sonnet
effort: high
allowed-tools:
  - Read
