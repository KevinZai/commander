...
# CC Commander — AI PM for Claude Code · 63 Skills · 22 Agents · Free for Now

> **Ship faster with Claude Code and Cowork Desktop.** One plugin install activates 63 skills, 22 specialist AI agents, and 23 lifecycle hooks across Claude Code Desktop, Claude Code CLI, Cursor, Windsurf, and every MCP-capable IDE.
...
**What you get:** 63 click-first `/ccc-*` plugin skills · 22 specialist sub-agents (architect, reviewer, debugger, designer, and more) · 23 lifecycle hooks · 2 bundled MCP servers · 502+ ecosystem skills · Free for now.

<img src="docs/assets/hero.gif" alt="CC Commander v6.0.0 — Claude Code Desktop plugin demo" width="100%">

> **🖥️ Primary surface: Claude Code Desktop (aka Cowork Desktop).** Install once via Settings → Plugin Marketplace. All 63 plugin skills, 22 agents, 23 lifecycle hooks (38 handlers), and 2 credential-free bundled MCP servers (+16 opt-in via `/ccc-connect`) appear inside every session automatically — no terminal needed.
>
...
**[Why CC Commander](#-why-cc-commander)** · **[The 63 skills](#the-63-plugin-skills)** · **[Browse Skills](SKILLS-INDEX.md)** · **[Agent Bible](docs/BIBLE-AGENT.md)** · **[Ecosystem](docs/ECOSYSTEM.md)** · **[BIBLE](BIBLE.md)** · **[Changelog](CHANGELOG.md)**
...
✅ 63 plugin skills activate. ✅ Zero config. ✅ Zero API keys.
...
> **Commander is a PM layer for whichever AI coding tool you use.** Same 63 skills, same 22 specialist agents, same lifecycle hooks — different install path per platform. The package name stays `commander` everywhere; the surrounding UI (Claude Code, Codex, Cursor, etc.) provides the platform context.
...
- 🎯 **63 plugin skills** — 6 new channel/CI/ECC skills (`/ccc-brainstorm`, `/ccc-qa`, `/ccc-loop`, `/ccc-hermes`, `/ccc-nightwatch`, `/ccc-ci`) + 5 language reviewer agents (Go, Rust, Java, Kotlin, C#) + `/ccc-ultracode`.
...
- **Click-first front door** — 63 curated `/ccc-*` workflows via native chip pickers, instead of memorizing 156+ commands.
...
| **Skill count** | 502+ (63 plugin + 450+ ecosystem) | 156 | ~20 | ~15 |
...
All 63 plugin skills, 22 specialist agents, 23 lifecycle hooks, 2 bundled MCP servers, and 16 opt-in connectors — free, no credit card, no feature gating.
...
You get:  A guided AI project manager with 502+ skills,
          63 plugin skills, 22 agents, 18 vendor packages,
...
| Plugin Skills | 63 | Desktop-first skills (13 /ccc-* workflows + 11 domain routers + 6 new channel/ECC skills + meta + vendor-sourced + session management) |
...
**What you get:** 63 plugin skills, 22 specialist agents, 23 lifecycle hooks (38 handlers), 2 credential-free bundled MCP servers + 16 opt-in via `/ccc-connect`. Free for now.
