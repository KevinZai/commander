...
> CC Commander v6.8.3 — by Kevin Zicherman — commands, workflows, and power user tips
...
## Desktop Plugin Commands (v6.8.3)
...
CC Commander v6.8.3 — the Desktop plugin is the primary surface. Invoke the interactive hub with plain `/ccc` in Claude Desktop:
...
## CC Commander v6.8.3 Quick Reference (CLI)
