...
| **Skill browser** | Browse all 453+ skills from within Commander |
...
`recommendSkills(task, techStack)` ranks all 453+ skills using three signals:
...
- **Curation:** 453+ skills are pre-screened. Low-signal skills are excluded. High-signal ones are cross-wired.
