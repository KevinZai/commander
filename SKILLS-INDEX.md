...
> CC Commander v5.1.2 — by Kevin Zicherman
...
*⭐ = added in CC Commander v5.1.2 and kept current with each release. Desktop plugin skills (plain `/ccc-*` namespace) added in v5.1.2, updated in v5.1.2.*
