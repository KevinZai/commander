...
> CC Commander v6.7.1 — by Kevin Zicherman — commands, workflows, and power user tips
...
## Desktop Plugin Commands (v6.7.1)
...
> **New in v6.7.1 — Engagement Engine**
...
CC Commander v6.7.1 — the Desktop plugin is the primary surface. Invoke the interactive hub with plain `/ccc` in Claude Desktop:
...
## CC Commander v6.7.1 Quick Reference (CLI)
