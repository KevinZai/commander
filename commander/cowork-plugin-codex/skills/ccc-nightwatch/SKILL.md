---
name: ccc-nightwatch
description: "[C:plugin] — Remote YOLO control. Run /ccc night (autonomous mode), go to sleep, approve/deny tool use from your phone via Telegram/Discord. Auto-classifies risk — file reads auto-allow, rm/deploy ask human, dangerous ops always-deny. Pairs with PreToolUse permission hook. Requires OpenClaw Gateway or webhook receiver. Use when the user types /ccc-nightwatch, 'approve from phone', 'remote YOLO', 'run overnight', 'autonomous with safety leash'."
allowed-tools:
  - Read
  - Bash
  - AskUserQuestion
