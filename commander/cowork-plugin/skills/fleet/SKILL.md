---
name: fleet
description: "[C:plugin] — \"Launch parallel agents for multi-step or parallelizable tasks. Use when: 'fleet', 'parallel agents', 'launch workers', 'multi-agent', 'swarm', 'run in parallel',…"
allowed-tools:
  - Read
  - Write
  - Edit
