---
name: ccc-ultracode
description: "Activate ultracode mode — xhigh reasoning + automatic dynamic-workflow orchestration. Claude plans a Workflow per substantial task, spawning adversarial subagents that cross-check findings before reporting. Resets each session; requires Opus 4.8+ and CC v2.1.154+."
allowed-tools:
  - Read
  - Bash
  - Workflow
