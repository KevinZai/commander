---
name: save-session
description: "[C:lifecycle] — Compress the current Claude Code session into a dense reloadable summary — key decisions, files modified, what worked, what did NOT work, open questions, and the…"
model: sonnet
effort: medium
---
