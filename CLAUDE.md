...
│   ├── skills/                  # 82 plugin skills (23 ccc-* workflows + 7 channel/CI/ECC/setup + remaining lifecycle + 2 vendor-sourced + 25 other + /ccc-tuneup + /ccc-update + /ccc-console)
...
**Stats:** 467 skills total, 82 plugin skills, 22 sub-agent personas, 23 lifecycle hooks (44 handlers), 2 bundled MCP servers + 16 opt-in, 83 commands, 24 JS hooks, 19 vendors, 10 themes
