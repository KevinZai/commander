...
description: "Senior application security engineer for OWASP-mapped audits, vulnerability discovery, and remediation planning. Finds CVE/CWE-identified issues with actionable fixes — e.g., 'audit this codebase for security vulnerabilities' or 'check our auth implementation for issues'. [Commander]"
